...
const Banner = () => {
  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:mx-14 lg:px-12 my-20'>
      {/* ------- left side ------- */}
      <div className='flex-1 py-10 sm:py-10 md:py-16 md:mt-6 lg:pl-5'>
      ...
      <div className='hidden md:block md:w-1/3 lg:w-[370px] relative'>
        <img className='w-full  bottom-0 right-0 mt-8 pr-10 max-w-md' src={assets.appointment_img} alt="" />
      </div>
